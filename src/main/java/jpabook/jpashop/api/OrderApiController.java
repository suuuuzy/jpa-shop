...
public class OrderApiController {
    ...
    /**
     * V4. JPA에서 DTO 직접 조회, 컬렉션 N 조회(1+N Query)
     * - 페이징 가능
     */
    ...
    /**
     * V5. JPA에서 DTO 직접 조회, 컬렉션 1 조회 최적화 버전(1+1 Query)
    ...
    /**
     * V6. JPA에서 DTO 직접 조회, 플랫 데이터(1 Query)
     * - 조인 결과를 그대로 조회 후 애플리케이션에서 원하는 모양으로 직접 변환
     * - 페이징 불가능
     */
